...
export const inputCheckboxIconVariants = cva(
  "absolute top-1/2 lef-1 -translate-y-1/2 hidden peer-checked:block fill-white",
  {
    variants: {
      size: {
        md: "w-3 h-3",
